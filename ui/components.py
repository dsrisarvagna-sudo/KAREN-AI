...
class ConversationView(ttk.Frame):
    def __init__(self, parent: tk.Misc) -> None:
        ...
        self.text.tag_configure("user", foreground="#b9d8f4", spacing1=8)
        self.text.tag_configure("karen", foreground="#c9f0d8", spacing1=8)
    ...
    def add_message(self, message: ConversationMessage) -> None:
        tag = "user" if message.speaker.lower() == "you" else "karen"
        self.text.configure(state="normal")
        self.text.insert("end", f"{message.speaker}: ", tag)
